...
pub const TOPOLOGIES: &[Topology] = &[
    // ── Guitar ─────────────────────────────────────────────────────────────
    Topology {
        id: "guitar-singlecoil",
        label: "Single-coil",
        instrument: "guitar",
        seed: 0x1111_0002_0000_0002,
        freq: 5500.0,
        q: 2.0,
        peak: 0.50,
        bp_mix: 0.80,
    ...
    Topology {
        id: "guitar-active",
        label: "Active (EMG/Fluence)",
        instrument: "guitar",
        seed: 0x3333_0001_0000_0001,
        freq: 3500.0,
        q: 1.2,
        peak: 0.85,
        bp_mix: 0.45,
    ...
    Topology {
        id: "bass-singlecoil",
        label: "Bass single-coil",
        instrument: "bass",
        seed: 0x5555_0002_0000_0002,
        freq: 700.0,
        q: 2.0,
        peak: 0.55,
        bp_mix: 0.80,
    ...
    Topology {
        id: "bass-humbucker",
        label: "Bass humbucker",
        instrument: "bass",
        seed: 0x6666_0002_0000_0002,
        freq: 550.0,
        q: 2.2,
        peak: 0.60,
        bp_mix: 0.80,
