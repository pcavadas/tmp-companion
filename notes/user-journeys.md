...
| Journey                                                        | Coverage                                                                                    | Gate                                                                                 |
| -------------------------------------------------------------- | ------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------ |
| Calibrate a profile → re-level uses the fresh capture stimulus | **NONE — open gap.** Planned for this harness series but never implemented; no spec exists. | none yet — next bug/feature touching calibration must land this alongside its change |
...
| 2026-07                                                       | Same first-session report: implied by the app's calibration feature interacting with leveling ("added a noodle on the Jaguar then everything changed")           | Calibration-shift not reflected in re-level       | **open — no gate yet**                                                                                                                                                                 | none yet                                                         |
